...
namespace WinFormTestApp
{
	public partial class Form1 : Form
	{
		...
		public Form1(IShareService shareService)
		{
		...
		private void buttonCalculate_Click(object sender, EventArgs e)
		{
				...
				decimal.TryParse(textBoxPricePerShare.Text, out decimal pricePerShare))
			{
				...
				int totalAvailableShares = shareService.GetTotalAvailableShares();
				...
				try
				{
					var result = shareService.CalculateShares(sharesSold, pricePerShare);
		...
		private void buttonAddLot_Click(object sender, EventArgs e)
		{
			...
			{
				shareService.AddLot(newShares, newPrice);
